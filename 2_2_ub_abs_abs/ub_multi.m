...
% survey child insurance hailfinder
% ["survey"; "child"; "insurance"; "hailfinder"; "hepar2"]
dataset_name_set = ["survey"; "insurance"; "hepar2"; "hailfinder"];
...
for dne = 1:dn
    ...
    fn = result_dir + "ub_abs_" + dataset_name + ".txt";
    file_id = fopen(fn, 'w');
    ...
    for ene = 1:en
        ...
        [sub_num_t, gamma_cnt, theta_cnt] = ...
            get_ub_theta_absolute(epsilon, lambda_t, epsilon_g, ...
